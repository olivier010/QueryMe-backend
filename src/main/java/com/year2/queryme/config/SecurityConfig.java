        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                    ...
                    .requestMatchers(HttpMethod.POST, "/api/auth/signup").permitAll()
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/teachers/register").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.POST, "/api/admins/register").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.POST, "/api/guests/register").hasRole("ADMIN")
                        ...
                        .hasAnyRole("TEACHER", "ADMIN")
                        .requestMatchers("/api/course-enrollments/**")
                        .hasAnyRole("TEACHER", "ADMIN")
                        .requestMatchers(HttpMethod.POST, "/api/exams/**")
                        .hasAnyRole("TEACHER", "ADMIN")
                        .requestMatchers(HttpMethod.PUT, "/api/exams/**")
                        .hasAnyRole("TEACHER", "ADMIN")
                        .requestMatchers(HttpMethod.PATCH, "/api/exams/**")
                        .hasAnyRole("TEACHER", "ADMIN")
                        .requestMatchers(HttpMethod.DELETE, "/api/exams/**")
                        .hasAnyRole("TEACHER", "ADMIN")
                        .requestMatchers(HttpMethod.POST, "/api/exams/*/questions")
                        .hasAnyRole("TEACHER", "ADMIN")
                        .requestMatchers(HttpMethod.PUT, "/api/exams/*/questions/**")
                        .hasAnyRole("TEACHER", "ADMIN")
                        .requestMatchers(HttpMethod.GET, "/api/results/exam/**")
                        .hasAnyRole("TEACHER", "ADMIN")
                        ...
                        .hasAnyRole("STUDENT", "TEACHER", "ADMIN")
                        .requestMatchers(HttpMethod.GET, "/api/results/session/**")
                        .hasAnyRole("STUDENT", "TEACHER", "ADMIN")
                        .requestMatchers(HttpMethod.POST, "/api/sessions/start")
                        .hasAnyRole("STUDENT", "TEACHER", "ADMIN")
                        .requestMatchers(HttpMethod.PATCH, "/api/sessions/*/submit")
                        .hasAnyRole("STUDENT", "TEACHER", "ADMIN")
                        .requestMatchers(HttpMethod.GET, "/api/sessions/*")
                        .hasAnyRole("STUDENT", "TEACHER", "ADMIN")
                        .requestMatchers(HttpMethod.GET, "/api/sessions/student/**")
                        .hasAnyRole("STUDENT", "TEACHER", "ADMIN")
                        .requestMatchers(HttpMethod.GET, "/api/sessions/exam/**")
                        .hasAnyRole("TEACHER", "ADMIN")
                        .requestMatchers("/api/query/**")
                        .hasAnyRole("STUDENT", "TEACHER", "ADMIN")
                        .requestMatchers("/api/sandboxes/**")
                        .hasAnyRole("TEACHER", "ADMIN")
